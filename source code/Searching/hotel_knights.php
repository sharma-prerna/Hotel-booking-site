...
<html>
    ...
    <body>
        ...
        <div class="flex-container">
            <div id="payment">
        <form  method="POST">
            <input type="text" name="id" value="3" class="input-box" readonly="true" disabled="true"><br>
                    <label>Hotel Name</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="text" name="hotel" value="Knights Inn" class="input-box" readonly="true"><br>
