...
<html>
    <head>
        ...
        <link rel="stylesheet" href="hotel_css.css">
         <style>
             .flex-container{
                 background-image: linear-gradient(0deg,rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url("../images/proxima/proxima1.jpg")
             }
    </style>
    </head>
    <body>
        ...
        <div class="flex-container">
            <div id="payment">
               <form  method="POST">
                <input type="text" name="id" value="5" class="input-box" readonly="true" disabled="true"><br>
                    <label>Hotel Name</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="text" name="hotel" value="Proxima" class="input-box" readonly="true"><br>
                    <label>Room Types</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="text" name="room" value="Deluxe,Super Deluxe and Standard" class="input-box" readonly="true"><br>
                    <label>Price per person(INR)</label>:<input type="text" name="price" value="2500" class="input-box" readonly="true"><br>
